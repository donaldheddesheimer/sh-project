...
| `recall_experience` | `run_id`, `limit?` (1–10) | The playbook and the most similar past episodes | Added with the autonomous episode. Lessons advise what to simulate first; they never replace simulating. |

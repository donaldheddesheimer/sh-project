...
> This is the former root README, preserved on 2026-09-20 for implementation history,
> validation notes, and milestone context. It is not the current setup guide; links were
> written relative to the repository root and are retained as part of the snapshot.
